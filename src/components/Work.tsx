...
const projects = [
  {
    ...
    description:
      "Developed an intelligent conversational chatbot that provides instant and accurate currency conversion using real-time exchange rates. Integrated a third-party API to fetch live financial data and implemented the core logic in Python to process user inputs and generate calculated conversions.",
              ...
              {projects.map((project, index) => (
                <div className="carousel-slide" key={index}>
                  <div className="carousel-content">
                    ...
                    <div className="carousel-center-dot" aria-hidden="true"></div>
